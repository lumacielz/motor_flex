...
def composicaoAdiabatica(estimative,T,P):
    while True:
        sol = minimize(gibbs, estimative,args=(T,P), method='SLSQP', bounds=bnds, constraints=cons)
...
##composicao final
    ...
    print({'MASS_FRACTION':{'Combustivel': sol.x[0] * mass[0] / total_mass, 'O2': sol.x[1] * mass[1] / total_mass,
                        'H2O': sol.x[2] * mass[2] / total_mass, 'CO2': sol.x[3] * mass[3] / total_mass, 'CO': sol.x[4] * mass[4] / total_mass,'O':sol.x[5] * mass[5] / total_mass,'N':sol.x[6] * mass[6] / total_mass,'NO2':sol.x[7] * mass[7] / total_mass,'NO':sol.x[8] * mass[8] / total_mass,'OH':sol.x[9] * mass[9] / total_mass,'H2':sol.x[10] * mass[10] / total_mass,'H':sol.x[11] * mass[11] / total_mass,'N2':sol.x[12] * mass[12] / total_mass}})
