...
for k in range(len(tk)):
    ...
    gt_comb=(h_comb-Temp[k]*deltaS["deltasComb"])/constant
    ...
    if k<=99:
        ...
        estimative=sol.x
        Tadiab=float(temperaturaAdiabatica(estimative,Temp[k],Temp[k]+1))
        ...
        h_h2o,h_co2,h_o2,h_co,h_n2,h_comb,h_no,h_no2,h_oh,h_h2,h_h,h_n,h_o=interpolacaoH(Tadiab) 
...
#ax.scatter(Temp[:100],list(map(lambda x:x*10**3,ent_prod[:100])),color="c")
...
plot.plot(Temp[99:200],composicao_co2[99:200],'o')
plot.legend(['CO2'])
